...
ALLOWED_HOSTS = ["www.travelbeyondkerala.in", "trvel.onrender.com", "web-production-3a8b.up.railway.app", "telusko.onrender.com", "127.0.0.1', 'localhost"]
...
CSRF_TRUSTED_ORIGINS = [
    "https://www.travelbeyondkerala.in",
]
